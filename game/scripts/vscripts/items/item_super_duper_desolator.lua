LinkLuaModifier ("modifier_item_desolator_3", "items/item_super_duper_desolator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier ("modifier_item_desolator_3_corruption", "items/item_super_duper_desolator.lua", LUA_MODIFIER_MOTION_NONE)

if item_super_duper_desolator == nil then
    item_super_duper_desolator = class ( {})
end

function item_super_duper_desolator:GetBehavior()
    local behav = DOTA_ABILITY_BEHAVIOR_PASSIVE
    return behav
end

function item_super_duper_desolator:GetIntrinsicModifierName ()
...
function item_super_duper_desolator:GetAbilityTextureName() return self.BaseClass.GetAbilityTextureName(self)  end 