...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	elseif GetMapName() == "dnepr_river_tdm" then
	GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 5 )
	GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 5 )
    ...
    GameRules:GetGameModeEntity():SetCustomHeroMaxLevel( 35 ) -- максимальный уровень
...
function COverthrowGameMode:ExecuteOrderFilter( filterTable )
 ...
 function lvlup(hero)
    if hero:HasAbility("roshan_attributes") then hero:FindAbilityByName("roshan_attributes"):SetLevel(1) end
end
